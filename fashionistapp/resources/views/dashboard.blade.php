        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="pages/email/inbox.html" class="nav-link">All Users</a>
                </li>
                <li class="nav-item">
                  <a href="pages/email/read.html" class="nav-link">Roles List</a>
                </li>
                <li class="nav-item">
                    <a href="pages/email/read.html" class="nav-link">Permission</a>
                  </li>
                </ul>
            </div>
            </li>
          <li class="nav-item nav-category">Client Management</li>
          <li class="nav-item">
            ...
            <li class="nav-item nav-category">Measurement Mgt</li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#uiComponents" role="button" aria-expanded="false" aria-controls="uiComponents">
              <i class="link-icon" data-feather="feather"></i>
              <span class="link-title">New Measurement</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
              <a class="nav-link" data-bs-toggle="collapse" href="#uiComponents" role="button" aria-expanded="false" aria-controls="uiComponents">
                <i class="link-icon" data-feather="feather"></i>
                <span class="link-title">View Measurement</span>
                <i class="link-arrow" data-feather="chevron-down"></i>
                <a class="nav-link" data-bs-toggle="collapse" href="#uiComponents" role="button" aria-expanded="false" aria-controls="uiComponents">
                    <i class="link-icon" data-feather="feather"></i>
                    <span class="link-title">Edit Measurement</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                    <a class="nav-link" data-bs-toggle="collapse" href="#uiComponents" role="button" aria-expanded="false" aria-controls="uiComponents">
                        <i class="link-icon" data-feather="feather"></i>
                        <span class="link-title">Delete Measurement</span>
                        <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#general-pages" role="button" aria-expanded="false" aria-controls="general-pages">
              ...
              <span class="link-title">New Projects</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <a class="nav-link" data-bs-toggle="collapse" href="#general-pages" role="button" aria-expanded="false" aria-controls="general-pages">
                <i class="link-icon" data-feather="book"></i>
                <span class="link-title">Existing Projects</span>
                <i class="link-arrow" data-feather="chevron-down"></i>
              </a>
            <div class="collapse" id="general-pages">
          </li>
          </li>
          <li class="nav-item nav-category">Finance Management</li>
              <ul class="nav sub-menu">
              <li class="nav-item">
                <a href="/pages/advanced-ui/cropper.html" class="nav-link">New Payment</a>
              </li>
              <li class="nav-item">
                <a href="/pages/advanced-ui/owl-carousel.html" class="nav-link'>Owl carousel</a>
              </li>
              <li class="nav-item">
                <a href="/pages/advanced-ui/sortablejs.html" class="nav-link">All Payment</a>
              </li>
              <li class="nav-item">
                <a href="/pages/advanced-ui/sweet-alert.html" class="nav-link">Balance</a>
              </li>
            </ul>
          </li>
        </ul>
    ...
    <nav class="settings-sidebar">
      <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
          ...
          <a class="theme-item active" href="{{ asset('template/demo1/dashboard.html')}}">
            <img src="{{ asset('template/assets/images/screenshots/light.jpg')}}" alt="light theme">
          </a>
          <h6 class="text-muted mb-2">Dark Theme:</h6>
          <a class="theme-item" href="{{ asset('template/demo2/dashboard.html')}}">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex flex-column">
                  ...
                  <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                    <div class="me-3">
                      <img src="{{ asset('template/assets/images/faces/face4.jpg')}}" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                  ...
                  <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                    <div class="me-3">
                      <img src="{{ asset('template/assets/images/faces/face5.jpg')}}" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                  ...
                  <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                    <div class="me-3">
                      <img src="{{ asset('template/assets/images/faces/face6.jpg')}}" class="rounded-circle wd-35" alt="user">
                    </div>
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
...
<!-- Mirrored from www.nobleui.com/html/template/demo1-ds/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 May 2023 19:47:47 GMT -->
</html>
