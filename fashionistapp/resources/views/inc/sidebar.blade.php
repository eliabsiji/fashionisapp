            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="contact">
                  <ul class="nav sub-menu">
                    ...
                    <li class="nav-item">
                      <a href="pages/email/read.html" class="nav-link">All contacts</a>
                    </li>
              ...
              <li class="nav-item">
                  ...
                  <div class="collapse" id="finance">
                    <ul class="nav sub-menu">
                      <li class="nav-item">
                        <a href="pages/email/inbox.html" class="nav-link">New Payment</a>
                      </li>
                      <li class="nav-item">
                        <a href="pages/email/inbox.html" class="nav-link">All Payment</a>
                      </li>
                      <li class="nav-item">
                        <a href="pages/email/inbox.html" class="nav-link">Balance Payment</a>
                      </li>
                      </ul>
                  </div>
                </li>
                <li class="nav-item">
                  ...
                  <div class="collapse" id="invoice">
                    <ul class="nav sub-menu">
                      ...
                      <li class="nav-item">
                        <a href="pages/email/read.html" class="nav-link">Invoice</a>
                      </li>
